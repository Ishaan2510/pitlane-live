...
@keyframes flip-digit {
  0%   { transform: rotateX(0);      color: var(--text-primary); }
  40%  { transform: rotateX(-90deg); color: var(--accent); }
  60%  { transform: rotateX(-90deg); color: var(--accent); }
  100% { transform: rotateX(0);      color: var(--text-primary); }
}
...
.hero-btn.primary   { background: var(--accent); color: var(--text-inverse); border: 1px solid var(--accent); }
.hero-btn.primary:hover  { background: var(--accent-hover); transform: translateX(2px); }
.hero-btn.secondary { background: transparent; color: var(--text-primary); border: 1px solid var(--border-secondary); }
...
.cal-title { font-family: 'Bebas Neue', sans-serif; font-size: 1.4rem; letter-spacing: 0.1em; color: var(--text-faint); }
...
.year-btn:hover  { border-color: var(--border-secondary); color: var(--text-secondary); }
...
.cal-skeleton { height: 56px; background: var(--bg-secondary); animation: shimmer 1.5s ease infinite; }
...
.cal-row.completed:hover   { opacity: 0.7; background: var(--accent-dim); }
.cal-row.upcoming:hover    { background: var(--accent-dim); cursor: pointer; }
...
.cal-row.next .cr-name     { color: var(--text-primary); }
.cal-row.next .cr-num      { color: var(--accent); }

.cr-round { display: flex; flex-direction: column; align-items: flex-start; }
.cr-rd  { font-size: 0.52rem; letter-spacing: 0.1em; color: var(--text-faint); font-weight: 700; }
.cr-num { font-family: 'Bebas Neue', sans-serif; font-size: 1.5rem; color: var(--border-secondary); line-height: 1; }

.cr-status-col { display: flex; justify-content: center; }
.status-pip { font-size: 0.65rem; color: var(--border-secondary); width: 16px; text-align: center; font-weight: 700; }
.live-pip   { display: block; width: 8px; height: 8px; background: var(--accent); border-radius: 50%; animation: pulse-hero 1s ease infinite; margin: auto; }
.done-pip   { color: var(--border-secondary); font-size: 0.6rem; }
.next-pip   { color: var(--accent); }

.cr-info    { padding: 0 1rem; }
.cr-name    { font-size: 0.95rem; font-weight: 600; color: var(--text-secondary); margin-bottom: 0.15rem; }
.cr-loc     { font-size: 0.72rem; color: var(--text-faint); display: flex; align-items: center; gap: 0.35rem; }
...
.cr-date    { font-family: monospace; font-size: 0.8rem; color: var(--text-faint); font-weight: 600; }
.cal-row.next .cr-date { color: var(--text-secondary); }
.cal-row.live .cr-date { color: var(--text-secondary); }

.cr-cta     { font-size: 0.68rem; font-weight: 800; letter-spacing: 0.08em; display: block; text-align: right; }
.live-cta   { color: var(--accent); }
.replay-cta { color: var(--text-faint); }
.next-cta   { color: var(--accent); opacity: 0.6; }
.muted-cta  { color: var(--border-secondary); font-weight: 600; }
.cal-row.next .next-cta  { opacity: 1; }
.cal-row:hover .replay-cta { color: var(--text-secondary); }
...
@media (max-width: 768px) {
  ...
  .cd-digit  { width: 36px; height: 50px; font-size: 2.1rem; }
  .cd-sep    { font-size: 1.8rem; padding-bottom: 16px; }
  .cd-unit   { margin: 0 3px; }
  .hero-actions { flex-direction: row; flex-wrap: wrap; gap: 0.4rem; }
